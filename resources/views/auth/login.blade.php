                ...
                <form method="POST" action="{{ route('login') }}">
        			...
        			<div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="email" name="email" :value="old('email')" required autofocus  id="email" class="form-control" aria-label="email" aria-describedby="basic-addon1">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="password" name="password" :value="old('password')" required autofocus  id="password" class="form-control" aria-label="password" aria-describedby="basic-addon1">
                        </div>
